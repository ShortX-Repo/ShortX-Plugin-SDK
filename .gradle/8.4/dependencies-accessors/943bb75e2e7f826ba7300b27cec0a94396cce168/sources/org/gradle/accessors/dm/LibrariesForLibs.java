...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinStdlibLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public KotlinStdlibLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getCommon() {
                return create("kotlin.stdlib.common");
        }
    ...
    public static class ProtobufVersionAccessors extends VersionFactory  {
        ...
        public ProtobufVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: protobuf.java (3.25.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getJava() { return getVersion("protobuf.java"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Returns the group of plugins at plugins.protobuf
         */
    ...
    public static class ProtobufPluginAccessors extends PluginFactory {
        private final ProtobufGradlePluginAccessors paccForProtobufGradlePluginAccessors = new ProtobufGradlePluginAccessors(providers, config);

        public ProtobufPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of plugins at plugins.protobuf.gradle
         */
        public ProtobufGradlePluginAccessors getGradle() {
            return paccForProtobufGradlePluginAccessors;
        }

    }

    public static class ProtobufGradlePluginAccessors extends PluginFactory {

        public ProtobufGradlePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for protobuf.gradle.plugin to the plugin id 'com.google.protobuf'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getPlugin() { return createPlugin("protobuf.gradle.plugin"); }
